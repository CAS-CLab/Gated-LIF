...
#CUDA_VISIBLE_DEVICES=6 nohup python train.py --dsr_da -amp -out_dir ./logs -model SEWResNet_GLIF_dsr -cnf ADD -device cuda:0 -dts_cache /mnt/lustre/GPU8/home/usr/dvs_datasets/DVSCIFAR10/cifar10dvs_cache_SEW -epochs 200 -T_max 64 -T 16 -data_dir /mnt/lustre/GPU8/home/usr/dvs_datasets/DVSCIFAR10 -lr 0.01 -b 32 > True_widePLIF7B_GLIF-T_16-anneal-no_TF_environ-dsr-epoch_200.log > 2>&1 &
...
def main():
    ...
    parser.add_argument('-j', default=16, type=int, metavar='N',
    ...
    parser.add_argument('--dsr_da', default=False, action='store_true', help='DownSample Resolution for SNNs')
    ...
    if args.model == 'SEWResNet_GLIF_dsr':
        assert args.T_train == args.T or args.T_train is None
        assert args.dsr_da == True
        net = smodels.__dict__[args.model](args.cnf, T=args.T)
    elif args.model == 'SEWResNet_GLIF':
        assert args.T_train == args.T or args.T_train is None
        net = smodels.__dict__[args.model](args.cnf, T=args.T)
    elif args.model == 'SEWResNet_GLIF_dropout':
        assert args.T_train == args.T or args.T_train is None
        net = smodels.__dict__[args.model](args.cnf, T=args.T)
    elif args.model == 'SEWResNet_vanillaLIF':
        assert args.T_train == args.T or args.T_train is None
        net = smodels.__dict__[args.model](args.cnf, T=args.T)
    else:
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('test_acc', test_acc, 'epoch', epoch, 'best so far', max_test_acc)
